...
func Default() *Table {
	...
	t.Register(Unit{Name: "fraction", Dimension: Ratio, Scale: 1})
	t.Register(Unit{Name: "percent", Dimension: Ratio, Scale: 0.01})
	// point 维度
	t.Register(Unit{Name: "point", Dimension: Point, Scale: 1})
	// time 维度：day 为基准
	t.Register(Unit{Name: "day", Dimension: Time, Scale: 1})
	t.Register(Unit{Name: "week", Dimension: Time, Scale: 7})
	t.Register(Unit{Name: "month", Dimension: Time, Scale: 30})
	t.Register(Unit{Name: "year", Dimension: Time, Scale: 365})
	// currency 维度
